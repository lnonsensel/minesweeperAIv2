...
class AgentMenu:
    ...
    def add_lr_spinbox(self, grid: tuple[int, int]):
        self.lr_spinbox_data = self.agent_elements.add_spinbox(grid, 'Learning rate', self.agent_preferences.lr, increment=0.01)
    ...
    def add_target_update_interval_spinbox(self, grid: tuple[int, int]):
        self.target_update_interval_spinbox_data = self.agent_elements.add_spinbox(grid, 'Target update interval', self.agent_preferences.target_update_interval, increment=1000)
    ...
    def update_preferences(self):
        ...
        self.agent_preferences.target_update_interval = self.target_update_interval_spinbox_data.variable.get()
    ...
    def add_agent_to_menu(self):
        elements = [self.add_lr_spinbox,
                    ...
                    self.add_target_update_interval_spinbox]
